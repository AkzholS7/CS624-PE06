...
import { CityType, LocationType } from '../types/types'; // adjust path if needed

type CityScreenParams = {
  city: CityType;
  cities: CityType[];
...
class City extends React.Component<CityProps, CityState> {
  ...
  onChangeText = (key: keyof CityState, value: string) => {
  ...
  addLocation = () => {
    ...
    const location: LocationType = { name, info };
